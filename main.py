...
def attack(char_name: str, char_class: str) -> str:
    """Функция для вычисления количества урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для вычисления количества очков блокировки."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция для применения особых умений."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция для начала тренировки после выбора персонажа.
    В начале описывается выбранный персонаж, затем идет тренировка.
    Обучение возможно пропустить, благодаря команде "skip".
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция для выбора стартового персонажа, с подтверждением выбора."""
    approve_choice: str = ''
    char_class: str = ''
